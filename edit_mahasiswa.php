            ...
            <div class="main-content">
                <div class="container-fluid">
                        <div class="col-md-6">
                            <?php
                            $id = $_GET['id'];
                            $query = mysqli_query($koneksi,"SELECT * FROM tbl_mahasiswa WHERE id_mhs = '$id'") or die(mysqli_error($koneksi));
                            $data = mysqli_fetch_array($query);
                            ?>
                            <div class="card" style="min-height: 484px;">
                                <div class="card-header"><h3>Ubah Form Mahasiswa</h3></div>
                                <div class="card-body">
                                    <form  action="proses_edit_mhs.php" method="post">
                                        <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">NIM</label>
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" id="exampleInputUsername2" placeholder="Masukkan NIM" maxlength="10"
                                                name="nim" required value="<?php echo $data['nim']; ?>"
                                                readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="exampleInputEmail2" placeholder="Masukkan Nama"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="id_prodi" id="prodi" class="form-control select2">
                                                    ...
                                                    <option value="KF">Kajian Film,Televisi Media</option>
                                                    <option value="BD">Bisnis Digital</option>
                                                    <option value="MR">Manajemen Ritek</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="tempat_lahir" placeholder="Masukkan Kota Lahir"
                                                name="tempat_lahir" required value="<?php echo $data['tempat_lahir']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Tanggal Lahir</label>
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" id="exampleInputConfirmPassword2" placeholder="Tanggal Lahir"
                                                name="tgl_lahir" required value="<?php echo $data['tgl_lahir']; ?>">
                                            </div>
                                        </div>
