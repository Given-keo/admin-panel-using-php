...
<head>
  ...
  <title>Data-Kuota | Booking Gunung</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column bg-gradient-light">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-primary topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <h4 class="text-light">Data Master Kuota</h4>
        ...
        <div class="container-fluid">
          ...
          <!-- untuk form  -->
            <h1 class="h3 mb-4 text-gray-800">Tambah Kuota Pendakian</h1>
            <form action="../proses-data-master/simpan_data_kuota.php" method="post">
              <div class="form-group">
                ...
                <select name="id_gunung" class="form-control" required>
                  ...
                  $gunung = mysqli_query($conn, "SELECT * FROM gunung WHERE status = 'active'");
              ...
              <div class="form-group">
                ...
                <select name="id_jalur" class="form-control" required>
                  <option value="">-- Pilih Jalur --</option>
                  <?php
                  $jalur = mysqli_query($conn, "SELECT jalur.*, gunung.nama_gunung 
                                        FROM jalur 
                                        JOIN gunung ON jalur.id_gunung = gunung.id 
                                        WHERE jalur.status = 'aktif'");
                  while ($j = mysqli_fetch_assoc($jalur)) {
                    echo "<option value='".$j['id']."'>".$j['nama_jalur']." - ".$j['nama_gunung']."</option>";
                  }
                  ?>
                </select>
              </div>
              ...
              <!-- <div class="form-group">
                <label>Tanggal Kuota</label>
                <input type="date" name="tanggal" class="form-control" required>
              </div> -->

              <div class="form-group">
                <label>Jumlah Kuota</label>
                <input type="number" name="jumlah_kuota" class="form-control" required>
              </div>
              ...
              <a href="../dashboard.php" class="btn btn-secondary mt-3 mb-3">Kembali</a>
            </form>
