...
<head>
  ...
  <title>Data-Gunung  | Booking Gunung</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column bg-gradient-light">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-primary topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <h4 class="text-light">Data Master Gunung</h4>
        ...
        <div class="container-fluid">
          ...
          <!-- untuk form  -->
            <h1 class="h3 mb-4 text-gray-800">Tambah Data Gunung</h1>
            <form action="../proses-data-master/simpan_data_gunung.php" method="post" enctype="multipart/form-data">
