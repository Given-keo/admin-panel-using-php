<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    ...
    <div id="collapseDataMaster" class="collapse" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="../../data-master/daftar_transaksi.php">Daftar Transaksi</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="collapseTransaksi" class="collapse" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="../../transaksi/metode_pembayaran.php">Daftar Pembayaran</a>
        <a class="collapse-item" href="../../transaksi/pembayaran.php">Metode Pembayaran</a>
      </div>
    </div>
  </li>
