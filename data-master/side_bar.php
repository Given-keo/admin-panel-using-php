  ...
  <li class="nav-item">
    ...
    <div id="collapseDataMaster" class="collapse" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="data_gunung.php">Data Gunung</a>
        <a class="collapse-item" href="data_jalur.php">Jalur Pendakian</a>
        <a class="collapse-item" href="data_paket_pendakian.php">Paket Pendakian</a>
        <a class="collapse-item" href="data_kuota.php">Kuota Harian</a>
        <a class="collapse-item" href="data_admin.php">Master Petugas / Admin</a>
        <a class="collapse-item" href="daftar_transaksi.php">Data Booking</a>
      </div>
    </div>
  </li>
