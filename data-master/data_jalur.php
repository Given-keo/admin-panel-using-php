...
<head>
  ...
  <title>Data-Jalur | Booking Gunung</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column bg-gradient-light">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-primary topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <h4 class="text-light">Data Master Jalur Pendakian</h4>
          <!-- Topbar Navbar -->
        ...
        <div class="container-fluid">
          ...
          <!-- untuk form  -->
          <h1 class="h3 mb-4 text-gray-800">Tambah Data Jalur Pendakian</h1>
            <form action="../proses-data-master/simpan_jalur_gunung.php" method="post">
              ...
              <div class="form-group">
                ...
                <textarea name="deskripsi_jalur" class="form-control" rows="4"></textarea>
              </div>
              <div class="form-group">
                <label>Status</label>
                <select name="status" class="form-control" required>
                  <option value="aktif">Dibuka</option>
                  <option value="nonaktif">Ditutup</option>
                </select>
              </div>
