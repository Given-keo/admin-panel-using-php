...
<head>
  ...
  <title>Data-Admin | Booking Gunung</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column bg-gradient-light">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-primary topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <h4 class="text-light">Data Master Admin</h4>
        ...
        <div class="container-fluid">
          ...
          <!-- untuk form  -->
          <h1 class="h3 mb-4 text-gray-800">Form Input Data Admin</h1>

          <div class="row">
          <div class="col-lg-12">
            <form action="../proses-data-master/simpan_data_admin.php" method="POST">
