...
<head>
  ...
  <title>Data-Paket-Pendakian | Booking Gunung</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column bg-gradient-light">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-primary topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <h4 class="text-light">Data Master Paket Pendakian</h4>
        ...
        <div class="container-fluid">
          ...
          <!-- untuk form  -->
           <h1 class="h3 mb-4 text-gray-800">Tambah Paket Pendakian</h1>
            <form action="../proses-data-master/simpan_data_paket.php" method="post">
              ...
              <div class="form-group">
                <label>Durasi Pendakian (hari)</label>
              ...
              <a href="data_paket.php" class="btn btn-secondary mb-4">Kembali</a>
            </form>
