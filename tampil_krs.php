                                        ...
                                        <div class="dt-responsive">
                                            <table id="simpletable"
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- 
                                                    mysql -> kalau misalkan php versi 4 kebawah
                                                    mysqli -> 
                                                    -->
                                                    <?php
...
tbl_mahasiswa 
INNER JOIN
t_krs on tbl_mahasiswa.nim = t_krs.nim
INNER JOIN
tbl_prodi
ON
tbl_mahasiswa.kode_prodi = tbl_prodi.kode_prodi 
GROUP BY tbl_mahasiswa.nim
;");
                                                    $no = 1;
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="cetak_krs.php?id=<?php echo $data['nim']; ?>">Cetak KRS</td>
                                                    <?php
                                                    $no++;
                                                    }
                                                    ?>
                        ...
                        <!-- <div class="col-md-6">
                            <div class="card" style="min-height: 484px;">
                                <div class="card-header"><h3>Input Form Mahasiswa</h3></div>
                                <div class="card-body">
