  ...
  <li class="nav-item">
    ...
    <div id="collapseDataMaster" class="collapse" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="../data-master/daftar_transaksi.php">Data Booking</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="collapseLaporan" class="collapse" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="laporan_booking.php">Laporan Booking</a>
        <a class="collapse-item" href="laporan_kuota.php">Laporan Kuota</a>
        <a class="collapse-item" href="laporan_pendapatan.php">Laporan Pendapatan/Metode</a>
      </div>
    </div>
  </li>
