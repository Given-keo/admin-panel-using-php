                        ...
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub">
                                    <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Data Mster</span> <span class="badge badge-danger">4</span></a>
                                    <div class="submenu-content">
                                        <a href="form-mahasiswa.php" class="menu-item">Data Mahasiswa</a>
                                        <a href="pages/widget-statistic.html" class="menu-item">Data Dosn</a>
                                        <a href="pages/widget-data.html" class="menu-item">Data Matakuliah</a>
                                        <a href="pages/widget-chart.html" class="menu-item">Data Program Studi</a>
                                    </div>
                                </div>
                                <div class="nav-lavel">Transaksi</div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-box"></i><span>Transaksi</span></a>
                                    <div class="submenu-content">
                                        <a href="transaksi_krs.php" class="menu-item">Rencana Studi</a>
                                        <a href="pages/ui/badges.html" class="menu-item">Nilai</a>
                                        <a href="pages/ui/buttons.html" class="menu-item">Kartu</a>
                                ...
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-edit"></i><span>Laporan</span></a>
                                    <div class="submenu-content">
                                        <a href="pages/form-components.html" class="menu-item">Lap. Mahasiswa</a>
                                        <a href="pages/form-addon.html" class="menu-item">Lap. Dosen</a>
                                        <a href="pages/form-advance.html" class="menu-item">Lap. Matakuliah</a>
                                        <a href="pages/form-advance.html" class="menu-item">Lap. Program Studi</a>
                                    </div>
                                </div>
                                <!-- <div class="nav-item">
