                ...
                <div class="col-md-6">
                    <div class="card" style="min-height: 484px;">
                        <div class="card-header">
                            <h3>Transaksi Rencana Studi</h3>
                        </div>
                        <div class="card-body">
                            <form class="forms-sample" method='post' action="proses_krs.php">

                                <div class="form-group row">
                                    <label for="exampleInputMobile" class="col-sm-3 col-form-label">Pilih
                                        Mahasiswa</label>
                                    <div class="col-sm-9">
                                        <!-- <input type="text" class="form-control" id="exampleInputMobile" placeholder="Pilih Prodi"> -->
                                        <select class="form-control select2" name="nim"
                                            onchange="pilih(this.value)">
                                            <?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select class="form-control select2" name="id_jadwal"
                                            ...
                                            tbl_jadwal
                                            ON
                                            tbl_dosen.nidn_dosen = tbl_jadwal.nidn_dosen
                                            INNER JOIN 
                                            tbl_matakuliah
                                            ON
                                            tbl_jadwal.kode_mk = tbl_matakuliah.kode_mk;
");

                                           
                                            while ($row2 = mysqli_fetch_array($query2)) { ?>
                                                <option value="<?= $row2['id_jadwal']; ?>">
                                                    <?= $row2['nama_dosen']; ?> ||
                                                    <?= $row2['kode_mk']; ?> ||
                                                    <?= $row2['hari']; ?> ||
                                                    <?= $row2['ruang']; ?> 
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="widget">
                                    <div class="widget-body">
                                        ...
                                        <small class="text-small mt-10 d-block">12% Bertambah dari Tahun Lalu</small>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="widget">
                                    <div class="widget-body">
                                        ...
                                        <small class="text-small mt-10 d-block">97% telah Bersertifikasi Dosen</small>
                                    </div>
                                    <div class="progress progress-sm">
                                ...
                                <div class="list-item-wrap">
                                    <div class="list-item">
                                        ...
                                        <div class="qickview-wrap">
                                            <div class="desc">
                                                <p>Pembagian KHS oleh Orang Tua akan dilaksanakan pada tanggal 18 Agustus 2025.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="list-item">
                                        <div class="item-inner">
                                            ...
                                            <div class="list-title"><a href="javascript:void(0)">Pengumuman Lbur Lebaran akan disampaikan paling lambat 2 minggu sebelumnya.</a></div>
                                            <div class="list-actions">
                                                <a href="#"><i class="ik ik-eye"></i></a>
                                                <a href="#"><i class="ik ik-inbox"></i></a>
                                                <a href="#"><i class="ik ik-edit-2"></i></a>
                                    ...
                                    <div class="list-item">
                                        <div class="item-inner">
                                            ...
                                            <div class="list-title"><a href="javascript:void(0)">Pembagian KHS oleh Orang Tua akan dilaksanakan pada tanggal 18 Agustus 2025.</a></div>
                                            <div class="list-actions">
                                                <a href="#"><i class="ik ik-eye"></i></a>
                                                <a href="#"><i class="ik ik-inbox"></i></a>
                                                <a href="#"><i class="ik ik-edit-2"></i></a>
